            ...
            <nav className="!bg-[#F8F9FA] w-full border-gray-200  fixed top-0 left-0 z-50 dark:bg-gray-900">
                <div className="w-[95%] !bg-[#F8F9FA] flex flex-wrap items-center justify-between mx-auto sm:p-0 sm:pb-4 md:p-4  ">
                    ...
                    <button data-collapse-toggle="navbar-default" type="button"
                        className="inline-flex order-12 items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
                       ...
                       " id="navbar-default">
                        {token && (
                            <ul
                                ...
                                <li>
                                    <NavLink to="Cart" className="py-2 px-1 text-gray-500 rounded hover:text-black">
                                        Cart
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="wishlist" className="py-2 px-1 text-gray-500 rounded hover:text-black">
                                        WishList
                                    </NavLink>
                                </li>
                                <li>
                                ...
                                <li>
                                    <NavLink to="Category" className="py-2 px-1 text-gray-500 rounded hover:text-black">
                                        Categories                                 </NavLink>
                                </li>
                                <li>
                                ...
                                <li>
                                    <NavLink to="allorders" className="py-2 px-1 text-gray-500 rounded hover:text-black">
                                        All Orders
                                    </NavLink>
                                </li>
                        ...
                        <div className=" w-[15%] md:!text-center sm:mt-5 lg:mt-0 lg:!text-right">
                            {
                                (
                                    token ? (
                                        <>
                                            <Link to="Cart" className="py-2 px-1 text-gray-500 rounded  hover:text-black sm:block lg:inline ">
...
// <nav className="bg-[#F8F9FA] w-full border-gray-200  fixed top-0 left-0 z-50 dark:bg-gray-900">
//     <div className="w-[95%] bg-[#F8F9FA] flex flex-wrap items-center justify-between mx-auto p-4">
//         <NavLink to="/" className="w-[1/6]">
//             <img src={img1} className="w-[70%]" alt="icon" />
//         </NavLink>
...
//                     {token && (
//                         <ul className="w-full font-medium flex flex-col p-2 lg:p-0 mt-4 border border-gray-100 rounded-lg !bg-[#F8F9FA] lg:flex-row lg:space-x-8 rtl:space-x-reverse lg:mt-0 md:border-0 lg:items-center lg:justify-center lg:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
//                             <li>
//                                 <NavLink to="/" className="py-2 px-1 text-gray-500 rounded hover:text-black" aria-current="page">
//                                     Home
//                                 </NavLink>
...
// </li>
// <li>
//     <NavLink to="allorders" className="py-2 px-1 text-gray-500 rounded hover:text-black  xl:mr-48 lg:mr-0 ">
//         All Orders
//     </NavLink>
// </li>
// <li className="   lg:flex lg:!flex-row  lg:flex-wrap     sm:!flex-col sm:flex  sm:!items-center sm:!justify-center sm:mx-auto ">
//     {token ? (
//         <>
//             <Link to="Cart" className="py-2 px-1 text-gray-500 rounded hover:text-black ">
//                 <i className="text-xl relative fa-solid fa-cart-shopping">
//                     <div className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-green-500 border-2 border-white rounded -top-5 -end-5 dark:border-gray-900">
//                         {numOfItems}
//                     </div>
